...
class SimpleCarEnv(gym.Env):
    ...
    def _create_fixed_obstacles(self):
        self._spawn_obstacle_car(10.0, self.lane_centers[1])
        self._spawn_obstacle_car(25.0, self.lane_centers[0])
        self._spawn_obstacle_car(35.0, self.lane_centers[1])
        self._spawn_obstacle_car(45.0, self.lane_centers[0])

    def _spawn_obstacle_car(self, x, y, yaw=0.0):
